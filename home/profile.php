        ...
        <header class="mt-5 py-5 bg-light border-bottom mb-4 text-white">
            <div class="container">
                <div class="text-center my-5">
                    ...
                    <?php
                        if(!empty($_GET['uid'])){
                            echo "<a href='task-create.php?assign=".$row['id']."' class='btn btn-success'>Hire+</a>";
                        }
                    ?>
                ...
                <div class="col-lg-8">
                    ...
                    <?php if(!empty($_GET['uid'])):?>
                        <?php
                            ...
                            $rower = mysqli_fetch_array($results_total);
                                        ...
                                        <?php  while($row = mysqli_fetch_array($result)):?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    echo "<p><a href='profile.php?uid=$prov'>".$rows['prov_firstname']." ".$rows['prov_lastname']."</a></p>";
                                                ?></td>
                                                <td>
                                                    <?php
