                    ...
                    <div class="row row-cols-1 row-cols-md-2 mb-5">
                        <?php   
                            ...
                            if(isset($_POST["search"]) || isset($_GET['pages_no'])):
                                ...
                                $sql = "SELECT * FROM `tbl_provider` WHERE ((prov_category LIKE '%$search%') OR (prov_firstname LIKE '%$search%') OR (prov_lastname LIKE '%$search%')) LIMIT $offset, $total_records_per_page"; /* add where clause here */
