                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <form action="search.php" method="post">
                                        <li><input type="submit" value="Carpenter"  name="search" style="all:unset;color:#0D6EFD;"></li>
                                        <li><input type="submit" value="Plumber"  name="search" style="all:unset;color:#0D6EFD;"></li>
                                        <li><input type="submit" value="Painter"  name="search" style="all:unset;color:#0D6EFD;"></li>
                                    </form>
                                    </ul>
                                </div>
                                <div class="col-sm-4">
