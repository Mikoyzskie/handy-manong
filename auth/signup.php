              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="signup.php">
                    ...
                    <div class="mb-3">
                      <input type="password" minlength="8" class="form-control passwordToCheck" value="<?php echo $password?>" placeholder="Create a password" aria-label="Password" aria-describedby="password-addon" name="password" required>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-dark w-100 mt-4 mb-3" id ="buttonSubmit">Sign up</button>
